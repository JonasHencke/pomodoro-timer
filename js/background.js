export default function setBackground(name) {
    switch (name) {
        case 'gas_station':
            document.body.style.background = 'url(https://images.pexels.com/photos/5411700/pexels-photo-5411700.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2) 50% center / cover no-repeat';
            break;
        case 'starry_night':
        ...
        case 'virtual_reality':
            document.body.style.background = 'url("https://images.pexels.com/photos/8721342/pexels-photo-8721342.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2") 58% center / cover no-repeat fixed';
            break;
        case 'tokyo_tower':
            ...
            break;
        case 'mountains':
            document.body.style.background = 'url(https://images.pexels.com/photos/1743381/pexels-photo-1743381.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2) 50% center / cover no-repeat';
            break;
        case 'corals':
